 ...
 * Description:       WordPress 를 QuizDeck(myquizdeck.com)의 headless CMS 로 만드는 단일 mu-plugin — platform(코드 소유 defines·headless 하드닝) · content(CPT 4종·검증 게이트·REST 서빙 계약·편집 웹훅) · media(R2 offload — 포터블 모듈) · locale(ko_KR 고정) · annotations(회원 주석 관리 — 앱 API 서버-서버) · sso(wp-admin 앱 계정 OIDC 로그인) · admin(운영 대시보드·편집 작업 큐). ADR-0025~0028.
 * Version:           2.21.0
 * Author:            young1ll
