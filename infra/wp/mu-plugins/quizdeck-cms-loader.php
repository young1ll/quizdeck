 ...
 * Description: WordPress 를 QuizDeck 의 headless CMS 로 — 플랫폼 행동(코드 소유·headless 하드닝) + 콘텐츠 모델(CPT·메타박스·검증 게이트) + REST 서빙 계약 + 편집 웹훅 + 미디어 R2 offload + ko_KR 고정 (ADR-0025/0026)
 * Version: 2.4.0
 *
