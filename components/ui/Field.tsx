  ...
  return (
    <label className="block">
      ...
      <input
        ...
        minLength={minLength}
        disabled={disabled}
        className="w-full rounded-control border border-[var(--border)] bg-[var(--bg)] px-3 py-2 text-sm text-[var(--fg)] outline-none focus:border-[var(--accent)] disabled:opacity-50"
      />
    </label>
  );
}
